...
- `SMTP_SSL` - if you need to enable SSL on the SMTP connection
- `SMTP_TLS` - if you need to enable TLS on the SMTP connection
- `SMTP_SSL_VERIFY_MODE` - specify the verification mode for openssl (`'none'`, or `'peer'`)
