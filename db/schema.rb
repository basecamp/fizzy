...
ActiveRecord::Schema[8.2].define(version: 2026_09_24_120001) do
  ...
  create_table "board_work_plan_proposal_assignments", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.uuid "account_id", null: false
  ...
  create_table "board_work_plan_proposals", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.uuid "account_id", null: false
    t.uuid "board_id", null: false
