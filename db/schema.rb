...
ActiveRecord::Schema[8.2].define(version: 2025_12_21_093000) do
  ...
  create_table "boards", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.boolean "manual_sorting_enabled", default: false, null: false
    t.string "name", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "cards", id: :uuid, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["board_id", "column_id", "position"], name: "index_cards_on_board_id_and_column_id_and_position"
